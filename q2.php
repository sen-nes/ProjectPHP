    ...
    <div id="container">
        ...
        <div id="body">
            ...
            <div class="container body-content">
                <div class="center">
                    <h3><span class="label label-warning">УСЛОВИЕ</span> Да се изведат всички книги от издадени през последната година</h3>
                    <hr>
                    ...
                    <?php 
                        $sql="select books.id,books.title,books.author,books.pages,books.genre,books.year from books where year in (select max(year) from books) order by books.title";

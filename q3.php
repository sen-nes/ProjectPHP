    ...
    <div id="container">
        ...
        <div id="body">
            ...
            <div class="container body-content">
                <div class="center">
                    <h3><span class="label label-warning">УСЛОВИЕ</span> Да се изведе броят на книгите от книжарниците в град Ruse</h3>
                    <hr>
                    <?php 
                        $sql="select count(*) as cntBooks from libraries,books where books.id_library=libraries.id and libraries.city=\"Ruse\"";
                        $retval = mysqli_query($conn, $sql);
                                if(! $retval ) {
                                    die('Could not enter data: ' . mysqli_error($conn));
                                }
                        foreach ($retval as $key => $value) {
                            echo "Брой на книгите: " . $value['cntBooks'];
                        }
                        ?>
                </div>
            </div>
